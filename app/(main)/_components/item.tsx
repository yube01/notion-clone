...
export const Item = ({
    ...
    return(
        ...
        className={cn
            ("group min-h-[27px] text-sm py-1 text-muted-foreground pr-3 w-full hover:bg-primary/5 flex items-center font-medium",
        ...
        >
            ...
            </span>
            {
                isSearch && (
                    ...
                    h-5 select-none items-center gap-1 rounde border bg-muted
